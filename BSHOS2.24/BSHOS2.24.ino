/*
  ...
  Пофикшено: Избавление от лишних переменных
  Добавлено: 
  ----Пофикшено и добавлено----
*/
...
// текст сообщения о включении розетки на постоянную
...
// текст сообщения о включении режима поддержания температуры на 10 градусов
#define MESSAGE_ON10  "On10"
// текст сообщения о включении режима поддержания температуры на 20 градусов
#define MESSAGE_ON20  "On20"
// текст сообщения о включении режима поддержания температуры на 25 градусов
...
void setRelay(char f_phone[], char f_message[])
{
  ...
  if (strcmp(f_message, MESSAGE_ON) == 0) {
    ...
    // и поддерживаем её в заданных пределах
    Serial.println("OK! Set temperature to 10");
    Serial.print("Temperature is: ");
    Serial.print(Temp);
    stateRelay = true;
    stat = 2;
    eeprom_write_byte(0, stat);
    gprs.sendSMS(f_phone, "OK! Set temperature to 10");
    
  } else if (strcmp(f_message, MESSAGE_ON20) == 0) {
    // если пришло сообщение с текстом «On20»,
    // измеряем температуру
    // и поддерживаем её в заданных пределах
    Serial.println("OK! Set temperature to 20");
    Serial.print("Temperature is: ");
    Serial.print(Temp);
    stateRelay = true;
    stat = 3;
    eeprom_write_byte(0, stat);
    gprs.sendSMS(f_phone, "OK! Set temperature to 20");
    Serial.print("Temperature is: ");
    Serial.print(Temp);
    ...
    // измеряем температуру
    // и поддерживаем её в заданных пределах
    Serial.println("OK! Set temperature to 25");
    stateRelay = true;
    stat = 4;
    eeprom_write_byte(0, stat);
    gprs.sendSMS(f_phone, "OK! Set temperature to 25");
    
  } else if (strcmp(f_message, MESSAGE_STATE) == 0) {
    // если пришло сообщение с текстом «State»,
    // отправляем сообщение с состоянием системы
    ...
    //Tempr2 = Tempr3;// преобразование в символьный тип
    ...
    Serial.println(" °C");
      ...
      if (Tempr2 == 0 )  {gprs.sendSMS(f_phone, "0 °C");}
      if (Tempr2 == 1 )  {gprs.sendSMS(f_phone, "1 °C");}
      if (Tempr2 == 2 )  {gprs.sendSMS(f_phone, "2 °C");}
      if (Tempr2 == 3 )  {gprs.sendSMS(f_phone, "3 °C");}
      if (Tempr2 == 4 )  {gprs.sendSMS(f_phone, "4 °C");}
      if (Tempr2 == 5 )  {gprs.sendSMS(f_phone, "5 °C");}
      if (Tempr2 == 6 )  {gprs.sendSMS(f_phone, "6 °C");}
      if (Tempr2 == 7 )  {gprs.sendSMS(f_phone, "7 °C");}
      if (Tempr2 == 8 )  {gprs.sendSMS(f_phone, "8 °C");}
      if (Tempr2 == 9 )  {gprs.sendSMS(f_phone, "9 °C");}
      if (Tempr2 == 10 )  {gprs.sendSMS(f_phone, "10 °C");}
      if (Tempr2 == 11 )  {gprs.sendSMS(f_phone, "11 °C");}
      if (Tempr2 == 12 )  {gprs.sendSMS(f_phone, "12 °C");}
      if (Tempr2 == 13 )  {gprs.sendSMS(f_phone, "13 °C");}
      if (Tempr2 == 14 )  {gprs.sendSMS(f_phone, "14 °C");}
      if (Tempr2 == 15 )  {gprs.sendSMS(f_phone, "15 °C");}
      if (Tempr2 == 16 )  {gprs.sendSMS(f_phone, "16 °C");}
      if (Tempr2 == 17 )  {gprs.sendSMS(f_phone, "17 °C");}
      if (Tempr2 == 18 )  {gprs.sendSMS(f_phone, "18 °C");}
      if (Tempr2 == 19 )  {gprs.sendSMS(f_phone, "19 °C");}
      if (Tempr2 == 20 )  {gprs.sendSMS(f_phone, "20 °C");}
      if (Tempr2 == 21 )  {gprs.sendSMS(f_phone, "21 °C");}
      if (Tempr2 == 22 )  {gprs.sendSMS(f_phone, "22 °C");}
      if (Tempr2 == 23 )  {gprs.sendSMS(f_phone, "23 °C");}
      if (Tempr2 == 24 )  {gprs.sendSMS(f_phone, "24 °C");}
      if (Tempr2 == 25 )  {gprs.sendSMS(f_phone, "25 °C");}
      if (Tempr2 == 26 )  {gprs.sendSMS(f_phone, "26 °C");}
      if (Tempr2 == 27 )  {gprs.sendSMS(f_phone, "27 °C");}
      if (Tempr2 == 28 )  {gprs.sendSMS(f_phone, "28 °C");}
      if (Tempr2 == 29 )  {gprs.sendSMS(f_phone, "29 °C");}
      if (Tempr2 == 30 )  {gprs.sendSMS(f_phone, "30 °C");}
      if (Tempr2 == 31 )  {gprs.sendSMS(f_phone, "31 °C");}
      if (Tempr2 == 32 )  {gprs.sendSMS(f_phone, "32 °C");}
      if (Tempr2 == 33 )  {gprs.sendSMS(f_phone, "33 °C");}
      if (Tempr2 == 34 )  {gprs.sendSMS(f_phone, "34 °C");}
      if (Tempr2 == 35 )  {gprs.sendSMS(f_phone, "35 °C");}
      if (Tempr2 == 36 )  {gprs.sendSMS(f_phone, "36 °C");}
      if (Tempr2 == 37 )  {gprs.sendSMS(f_phone, "37 °C");}
      if (Tempr2 == 38 )  {gprs.sendSMS(f_phone, "38 °C");}
      if (Tempr2 == 39 )  {gprs.sendSMS(f_phone, "39 °C");}
      if (Tempr2 == 40 )  {gprs.sendSMS(f_phone, "40 °C");}
